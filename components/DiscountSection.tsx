...
export default function DiscountSection() {
	return (
		<div className="bg-ecommerce-light col-span-12 grid md:grid-cols-12 gap-7 px-2 py-7">
			<h1 className="text-stroke font-bold md:col-span-12 overflow-hidden">
				Weekly discount. Weekly discount
			</h1>

			<Image
				src={jblImage}
				className="w-full place-self-center md:place-self-auto md:col-span-3 -mt-24 max-w-[350px]"
