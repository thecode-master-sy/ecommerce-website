  ...
  return (
    <div className="mt-48 grid gap-10">
      <div className="px-2 max-w-[700px]">
          <h2 className="text-header-three font-bold uppercase">
          Recieve latest updates on products and discounts
        </h2>
        <div className="flex flex-col md:flex-row gap-2 mt-2">
          <input
            type="search"
            className="w-full md:flex-grow border px-2 py-2 rounded-md border-input-border bg-ecommerce-light  text-input-border"
            name="search"
      ...
      <div className="overflow-hidden">
        <h1 className="uppercase text-stroke font-bold overflow-hidden">
          Logo.Logo. Logo.
        </h1>
      </div>
